...
function qod_scripts() {
	...
	wp_enqueue_scripts('api-home-page',get_template_directory_uri().'/build/js/api.min.js',array('jQuery'), false, true );
	wp_localize_script( 'api-home-page', 'api_vars', array(
